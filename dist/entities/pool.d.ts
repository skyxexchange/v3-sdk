import { BigintIsh, CurrencyAmount, Price, Token } from '@skyxexchange/sdk-core';
...
export declare class Pool {
    ...
    static getAddress(tokenA: Token, tokenB: Token, fee: FeeAmount, initCodeHashManualOverride?: string, poolDeployerAddressOverride?: string): string;
    /**
     * Construct a pool
