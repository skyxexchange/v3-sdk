import { MaxUint256, sqrt, Price, CurrencyAmount, Percent, TradeType, Fraction, sortedInsert, validateAndParseAddress } from '@skyxexchange/sdk-core';
import JSBI from 'jsbi';
import invariant from 'tiny-invariant';
import { defaultAbiCoder, Interface } from '@ethersproject/abi';
import { getCreate2Address } from '@ethersproject/address';
import { keccak256, pack } from '@ethersproject/solidity';
import IMulticall from '@skyxexchange/v3-periphery/artifacts/contracts/interfaces/IMulticall.sol/IMulticall.json';
import ISkyXV3Factory from '@skyxexchange/v3-core/artifacts/contracts/SkyXV3Factory.sol/SkyXV3Factory.json';
import INonfungiblePositionManager from '@skyxexchange/v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json';
import ISelfPermit from '@skyxexchange/v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json';
import IPeripheryPaymentsWithFee from '@skyxexchange/v3-periphery/artifacts/contracts/interfaces/IPeripheryPaymentsWithFee.sol/IPeripheryPaymentsWithFee.json';
import IQuoter from '@skyxexchange/v3-periphery/artifacts/contracts/lens/Quoter.sol/Quoter.json';
import IQuoterV2 from '@skyxexchange/swap-router-contracts/artifacts/contracts/lens/QuoterV2.sol/QuoterV2.json';
import ISwapRouter from '@skyxexchange/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json';
...
var _TICK_SPACINGS;
var POOL_DEPLOYER_ADDRESS = '0x4a13A5a8415527Ea24877f9860fD287Cb5cd4bBa';
var FACTORY_ADDRESS = '0x8C1FF117c5ad343Ddac145A9c1C974E704B8c3eD';
var ADDRESS_ZERO = '0x0000000000000000000000000000000000000000';
var POOL_INIT_CODE_HASH = '0x1b5c366cb0b7109926c0b161c0a85469fa485e75389d33a4dd753c35b22f157b';
/**
...
function computePoolAddress(_ref) {
  var poolDeployerAddress = _ref.poolDeployerAddress,
    tokenA = _ref.tokenA,
    tokenB = _ref.tokenB,
    fee = _ref.fee,
  ...
  return getCreate2Address(poolDeployerAddress, keccak256(['bytes'], [defaultAbiCoder.encode(['address', 'address', 'uint24'], [token0.address, token1.address, fee])]), initCodeHashManualOverride != null ? initCodeHashManualOverride : POOL_INIT_CODE_HASH);
}
...
var Pool = /*#__PURE__*/function () {
  ...
  Pool.getAddress = function getAddress(tokenA, tokenB, fee, initCodeHashManualOverride, poolDeployerAddressOverride) {
    return computePoolAddress({
      poolDeployerAddress: poolDeployerAddressOverride != null ? poolDeployerAddressOverride : POOL_DEPLOYER_ADDRESS,
      fee: fee,
      tokenA: tokenA,
      tokenB: tokenB,
...
/**
 * Represents a position on a SkyX V3 Pool
 */
...
var NonfungiblePositionManager = /*#__PURE__*/function () {
  ...
  NonfungiblePositionManager.encodeCreate = function encodeCreate(pool) {
    return NonfungiblePositionManager.FACTORY_INTERFACE.encodeFunctionData('createPool', [pool.token0.address, pool.token1.address, pool.fee]);
  ...
  NonfungiblePositionManager.encodeInitialize = function encodeInitialize(pool) {
  ...
  NonfungiblePositionManager.initializeCallParameters = function initializeCallParameters(pool) {
    return {
      calldata: this.encodeInitialize(pool),
      value: toHex(0)
    };
  };
  NonfungiblePositionManager.addCallParameters = function addCallParameters(position, options) {
    ...
    if (isMint(options) && options.createPool) {
      calldatas.push(this.encodeInitialize(position.pool));
    }
  ...
  NonfungiblePositionManager.addCallParameters1 = function addCallParameters1(position, options) {
    !JSBI.greaterThan(position.liquidity, ZERO) ? process.env.NODE_ENV !== "production" ? invariant(false, 'ZERO_LIQUIDITY') : invariant(false) : void 0;
    var calldatas = [];
    // create pool if needed
    if (isMint(options) && options.createPool) {
  ...
  NonfungiblePositionManager.addCallParameters2 = function addCallParameters2(position, options) {
    !JSBI.greaterThan(position.liquidity, ZERO) ? process.env.NODE_ENV !== "production" ? invariant(false, 'ZERO_LIQUIDITY') : invariant(false) : void 0;
    var calldatas = [];
    // get amounts
    var _position$mintAmounts2 = position.mintAmounts,
      amount0Desired = _position$mintAmounts2.amount0,
      amount1Desired = _position$mintAmounts2.amount1;
    // adjust for slippage
    var minimumAmounts = position.mintAmountsWithSlippage(options.slippageTolerance);
    var amount0Min = toHex(minimumAmounts.amount0);
    var amount1Min = toHex(minimumAmounts.amount1);
...
NonfungiblePositionManager.FACTORY_INTERFACE = /*#__PURE__*/new Interface(ISkyXV3Factory.abi);
NonfungiblePositionManager.INTERFACE = /*#__PURE__*/new Interface(INonfungiblePositionManager.abi);

/**
 * Represents the SkyX V3 QuoterV1 contract with a method for returning the formatted
...
/**
 * Represents the SkyX V3 SwapRouter, and has static methods for helping execute trades.
 */
...
export { ADDRESS_ZERO, FACTORY_ADDRESS, FeeAmount, FullMath, LiquidityMath, MaxUint128, Multicall, NoTickDataProvider, NonfungiblePositionManager, POOL_DEPLOYER_ADDRESS, POOL_INIT_CODE_HASH, Payments, Pool, Position, PositionLibrary, Route, SelfPermit, SqrtPriceMath, SwapMath, SwapQuoter, SwapRouter, TICK_SPACINGS, Tick, TickLibrary, TickList, TickListDataProvider, TickMath, Trade, computePoolAddress, encodeRouteToPath, encodeSqrtRatioX96, isMint, isSorted, maxLiquidityForAmounts, mostSignificantBit, nearestUsableTick, priceToClosestTick, subIn256, tickToPrice, toHex, tradeComparator };
