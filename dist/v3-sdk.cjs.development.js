...
var sdkCore = require('@skyxexchange/sdk-core');
var JSBI = _interopDefault(require('jsbi'));
var invariant = _interopDefault(require('tiny-invariant'));
var abi = require('@ethersproject/abi');
var address = require('@ethersproject/address');
var solidity = require('@ethersproject/solidity');
var IMulticall = _interopDefault(require('@skyxexchange/v3-periphery/artifacts/contracts/interfaces/IMulticall.sol/IMulticall.json'));
var ISkyXV3Factory = _interopDefault(require('@skyxexchange/v3-core/artifacts/contracts/SkyXV3Factory.sol/SkyXV3Factory.json'));
var INonfungiblePositionManager = _interopDefault(require('@skyxexchange/v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'));
var ISelfPermit = _interopDefault(require('@skyxexchange/v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'));
var IPeripheryPaymentsWithFee = _interopDefault(require('@skyxexchange/v3-periphery/artifacts/contracts/interfaces/IPeripheryPaymentsWithFee.sol/IPeripheryPaymentsWithFee.json'));
var IQuoter = _interopDefault(require('@skyxexchange/v3-periphery/artifacts/contracts/lens/Quoter.sol/Quoter.json'));
var IQuoterV2 = _interopDefault(require('@skyxexchange/swap-router-contracts/artifacts/contracts/lens/QuoterV2.sol/QuoterV2.json'));
var ISwapRouter = _interopDefault(require('@skyxexchange/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'));
...
function computePoolAddress(_ref) {
  ...
  return address.getCreate2Address(poolDeployerAddress, solidity.keccak256(['bytes'], [abi.defaultAbiCoder.encode(['address', 'address', 'uint24'], [token0.address, token1.address, fee])]), initCodeHashManualOverride != null ? initCodeHashManualOverride : POOL_INIT_CODE_HASH);
}
...
NonfungiblePositionManager.FACTORY_INTERFACE = /*#__PURE__*/new abi.Interface(ISkyXV3Factory.abi);
...
exports.POOL_DEPLOYER_ADDRESS = POOL_DEPLOYER_ADDRESS;
