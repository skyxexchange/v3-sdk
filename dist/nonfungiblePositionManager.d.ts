import { BigintIsh, Percent, CurrencyAmount, Currency, NativeCurrency } from '@skyxexchange/sdk-core';
...
export declare abstract class NonfungiblePositionManager {
    static FACTORY_INTERFACE: Interface;
    ...
    private static encodeInitialize;
    static initializeCallParameters(pool: Pool): MethodParameters;
    static addCallParameters(position: Position, options: AddLiquidityOptions): MethodParameters;
    static addCallParameters1(position: Position, options: AddLiquidityOptions): MethodParameters;
    static addCallParameters2(position: Position, options: AddLiquidityOptions): MethodParameters;
